...
\subsecao{7.3. Atualizar projetos Weaver já existentes}
...
\subsecao{7.4. Adicionando um módulo ao projeto Weaver}
...
\subsecao{7.5. Criar novo projeto}
...
A permissão dos diretórios criados será \monoespaco{drwxr-xr-x}
(|0755| em octal) para sistemas Unix. Naturalmente, o programa irá
respeitar qualquer valor pré-estabelecido de |umask|, o que pode
deixar as permissões finais diferentes. Em sistemas Windows, iremos
apenas herdar as permissões do diretório pai, já que o projeto de
sistemas de arquivo NTFS são baseados em uma lógica mais hierárquica.
