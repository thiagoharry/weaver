...
|block_size|: O tamanho ótimo do buffer utilizado para copiar conteúdo
 de arquivos. Em sistemas Unix tentamos descobrir tal valor. Nos
 demais usamos valores pré-determinados.
