...
#endif
#if !defined(_WIN32)
#include <sys/param.h> // Needed on BSD, but causes problem in Windows
#endif
...
\secao{Creating the Window and Managing User Input}

We manage the window and its input using only the functions from
window subsystem. To use the subsystem, we include its header:
