...
We will decalre a pointer for this function in struct \monoespaco{W} and this function will be invoked as \monoespaco{W.alloc()}:
...
rng = _Wcreate_rng(malloc, sizeof(W_RNG_SEED)/sizeof(uint64_t),
                   W_RNG_SEED);
#endif
@
\fimcodigo
...
sufficient to ensure the quality for any generator. How to do this
depends on the environment where the program is running.
