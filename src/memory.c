...
/*7:*/
#line 313 "./weaver-memory-manager.tex"

#if defined(__EMSCRIPTEN__) || defined(__unix__) || defined(__APPLE__)
#include <sys/mman.h> 
#endif
/*:7*//*12:*/
#line 391 "./weaver-memory-manager.tex"
...
#endif
/*:12*//*15:*/
#line 445 "./weaver-memory-manager.tex"

#if defined(__APPLE__) || defined(__unix__)
#include <unistd.h> 
#endif
/*:15*//*17:*/
#line 473 "./weaver-memory-manager.tex"

#if defined(_WIN32)
#include <windows.h>  
#endif
/*:17*//*19:*/
#line 526 "./weaver-memory-manager.tex"

#if defined(__unix__) || defined(__APPLE__)
#include <pthread.h> 
#endif
/*:19*//*29:*/
#line 779 "./weaver-memory-manager.tex"

#if defined(W_DEBUG_MEMORY)
#include <stdio.h> 
#endif
/*:29*//*31:*/
#line 821 "./weaver-memory-manager.tex"

#include <stdint.h> 
/*:31*/
#line 1084 "./weaver-memory-manager.tex"

#include "memory.h"
/*25:*/
#line 640 "./weaver-memory-manager.tex"

struct arena_header{
/*20:*/
#line 536 "./weaver-memory-manager.tex"
...
#endif
/*:20*/
#line 642 "./weaver-memory-manager.tex"
...
/*36:*/
#line 982 "./weaver-memory-manager.tex"
...
/*27:*/
#line 713 "./weaver-memory-manager.tex"
...
/*13:*/
#line 419 "./weaver-memory-manager.tex"

#if defined(__unix__)
p= sysconf(_SC_PAGESIZE);
#endif
/*:13*//*14:*/
#line 434 "./weaver-memory-manager.tex"

#if defined(__APPLE__)
p= getpagesize();
#endif
/*:14*//*16:*/
#line 458 "./weaver-memory-manager.tex"
...
#endif
/*:16*//*18:*/
#line 490 "./weaver-memory-manager.tex"

#if defined(__EMSCRIPTEN__)
p= 64*1024;
#endif
/*:18*/
#line 719 "./weaver-memory-manager.tex"
...
/*8:*/
#line 326 "./weaver-memory-manager.tex"
...
#endif
/*:8*//*10:*/
#line 362 "./weaver-memory-manager.tex"
...
#endif
/*:10*/
#line 725 "./weaver-memory-manager.tex"
...
/*21:*/
#line 554 "./weaver-memory-manager.tex"
...
#endif
/*:21*/
#line 681 "./weaver-memory-manager.tex"

}
}
/*:26*/
#line 727 "./weaver-memory-manager.tex"
...
/*28:*/
#line 753 "./weaver-memory-manager.tex"
...
bool ret= true;
/*22:*/
#line 568 "./weaver-memory-manager.tex"
...
#endif
/*:22*/
#line 759 "./weaver-memory-manager.tex"
...
#endif
/*9:*/
#line 343 "./weaver-memory-manager.tex"

#if defined(__EMSCRIPTEN__) || defined(__unix__) || defined(__APPLE__)
munmap(arena,M);
#endif
/*:9*//*11:*/
#line 381 "./weaver-memory-manager.tex"

#if defined(_WIN32)
UnmapViewOfFile(arena);
#endif
/*:11*/
#line 769 "./weaver-memory-manager.tex"
...
/*34:*/
#line 916 "./weaver-memory-manager.tex"
...
void*p= NULL;
/*23:*/
#line 581 "./weaver-memory-manager.tex"
...
/*33:*/
#line 874 "./weaver-memory-manager.tex"
...
/*32:*/
#line 834 "./weaver-memory-manager.tex"
...
/*:32*/
#line 881 "./weaver-memory-manager.tex"
...
p= header->left_free;
/*30:*/
#line 805 "./weaver-memory-manager.tex"
...
/*:30*/
#line 887 "./weaver-memory-manager.tex"
...
/*24:*/
#line 595 "./weaver-memory-manager.tex"
...
#endif
/*:24*/
#line 923 "./weaver-memory-manager.tex"
...
/*37:*/
#line 1000 "./weaver-memory-manager.tex"
...
#endif
/*:23*/
#line 1007 "./weaver-memory-manager.tex"
...
#endif
/*:24*/
#line 1025 "./weaver-memory-manager.tex"
...
if(point==NULL){
/*35:*/
#line 946 "./weaver-memory-manager.tex"
...
/*:35*/
#line 1055 "./weaver-memory-manager.tex"
