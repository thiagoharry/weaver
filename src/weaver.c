...
#include <pwd.h>  
#else
#line 1361 "weaver_program.tex"
#define SECURITY_WIN32
#include <Security.h> 
#include <Lmcons.h> 
#endif
#line 1365 "weaver_program.tex"
/*:38*//*42:*/
...
#else
#line 769 "weaver_program.tex"
 if(!CreateDirectoryA(current_string,NULL))
err= -1;
#endif
#line 772 "weaver_program.tex"
 current_string= va_arg(arguments,char*);
}
return err;
}
...
#else
#line 936 "weaver_program.tex"
 strcat(complete_path,"/.weaver");
#endif
#line 938 "weaver_program.tex"
}
}
free(complete_path);
}
...
#endif
#line 1070 "weaver_program.tex"
#endif
#line 1071 "weaver_program.tex"
...
#else
#line 1303 "weaver_program.tex"
 strcpy(author_name,string_to_copy);
#endif
#line 1305 "weaver_program.tex"
}
#endif
#line 1307 "weaver_program.tex"
/*:35*//*36:*/
...
err= chdir(argument);
#else
#line 1708 "weaver_program.tex"
 err= _chdir(argument);
#endif
#line 1710 "weaver_program.tex"
 if(err==-1)W_ERROR();
