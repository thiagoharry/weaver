...
|block_size|: The optimal size for the buffer utilized while copying
 files. In Unix systems we try to discover this value. In other
 systems we use predetermined values.
...
\secao{6. Initialization das Variáveis}
...
\negrito{Initialization:} Inicializamos tanto o |complete_path|
...
\negrito{Finishing}: Interrompemos a execução do loop se uma das
