...
\subsecao{6.9. arg\_is\_valid\_function: If the second argument could
...
\subsecao{6.10. author\_name: Code creator name}
...
\subsecao{6.11. project\_name: The project name}
...
\subsecao{6.12. year: Current year}
...
\subsecao{7.7. Creating a new main loop}
