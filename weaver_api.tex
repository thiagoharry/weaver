...
forem necessários. Por exemplo, o \monoespaco{stdlib.h} é necessário
em quase qualquer programa. Por exemplo, para podermos incluir as
definições de \monoespaco{size\_t}. Já o \monoespaco{stdint.h} também
...
espaço para a estrutura deles na estrutura \monoespaco{W}:
